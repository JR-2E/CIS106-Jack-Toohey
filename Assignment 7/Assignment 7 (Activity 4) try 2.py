# This program asks the user which shape they need the area of,
# then calculates it.
...
def processTriangle():
    ...
    print("The area of the triangle is " + str(triangleArea) + " square units.")
    
    return triangleArea

# Main
print("Which shape do you need to calculate the area of? A circle, triangle, square, rectangle, or rhombus?")
choice = input()
if choice == "circle" or choice == "Circle":
    processCircle()
else:
    if choice == "rectangle" or choice == "Rectangle" or choice == "square" or choice == "Square" or choice == "rhombus" or choice == "Rhombus":
        processRectangle()
    else:
